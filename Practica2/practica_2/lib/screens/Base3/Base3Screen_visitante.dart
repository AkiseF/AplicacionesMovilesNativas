          ...
          body: Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: colors.base3BackgroundColor,
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: colors.base3BorderColor,
                  width: 3,
                ),
                boxShadow: [
                  BoxShadow(
                        ...
                        child: Container(
                          ...
                          child: const Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10),
                              Text(
                                'Este nopal está adaptado a ambientes áridos y pedregosos. Sus cladodios almacenan agua, permitiéndole sobrevivir en condiciones áridas.',
                                style: TextStyle(
                              ...
                              SizedBox(height: 10),
                              Text(
                                '🌿 Preparate para taparte con las tunas!',
                                style: TextStyle(
                                  color: Colors.white70,
                                  fontSize: 12,
